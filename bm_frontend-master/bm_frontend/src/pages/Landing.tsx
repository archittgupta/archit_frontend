			...
			<div className="grid grid-cols-2 md:grid-cols-5 gap-8">
				<div className="space-y-4">
					...
					<div className="flex space-x-4">
						<a href="https://github.com/archittgupta/archit_frontend/" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-neon-green" aria-label="GitHub">
				...
				<div>
					...
					<ul className="space-y-2">
						<li><a href="https://discord.com/invite/Edtgnxnc37" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-neon-green">Discord</a></li>
						<li><a href="https://chat.whatsapp.com/IoiMk9ru9CpEew7dHJkHve" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-neon-green">Whatsapp</a></li>
						<li><a href="https://chess.com/club/en-passant-abesec" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-neon-green">Chess.com</a></li>
					</ul>
				</div>
				<div>
					<h3 className="text-lg font-semibold text-white mb-4">Socials</h3>
					<ul className="space-y-2">
						<li><a href="mailto:enpassantabesec@gmail.com" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-neon-green">Gmail</a></li>
						
						<li><a href="https://www.instagram.com/enpassant.abesec/?hl=en" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-neon-green">Instagram</a></li>
					</ul>
				</div>
				<div>
